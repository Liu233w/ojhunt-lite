"""
Tests for DMOJ crawler
"""

import pytest
import pytest_asyncio
import aiohttp
from ojhunt.crawlers.dmoj import __crawler_meta__, query

pytestmark = pytest.mark.network

# Test username from ojhunt.crawlers.test.js
...
async def test_valid_user(session):
    ...
    assert "aplusb" in result["solved_list"]
