"""
Tests for CodeForces crawler
"""

import pytest
from ojhunt.crawlers.codeforces import __crawler_meta__, query
...
async def test_username_with_space(session):
    ...
    # CodeForces API returns specific message for handles with spaces
...
async def test_valid_user(session):
    ...
    # Check for known solved problems
    expected_problems = {
        "754B",
        "165E",
        "492E",
