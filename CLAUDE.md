...
- **Edit `CLAUDE.md` directly** for project-wide conventions and instructions.
- **Subdirectory `CLAUDE.md` files** are auto-loaded when Claude reads files in those directories.

## Subdirectory Context

These load automatically when you work in the relevant area:
- `src/ojhunt/crawlers/CLAUDE.md` — HTML parsing, login types, metadata fields, license headers, archived crawlers
- `src/ojhunt/web/CLAUDE.md` — PDF internals, environment variables
- `src/ojhunt/cli/CLAUDE.md` — CLI login flags, credential testing patterns
- `tests/CLAUDE.md` — test structure, assertion conventions
- `tests/e2e/CLAUDE.md` — Playwright quirks
