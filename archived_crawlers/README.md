...
| bzoj | Domain offline, use darkbzoj crawler instead |
...
| eljudge (EIJudge) | Site dead (2016-2017) |
| fzu | Site dead (2012-2021) |
| hihocoder | User profiles require numeric IDs, no username lookup |
| hit | Site unreachable |
| hrbust | Site unreachable |
| jisuanke | Site migrated to SPA, requires authentication |
| leetcode_cn | Cloudflare bot protection |
| lightoj | SPA requires authentication |
| nod (51Nod) | API no longer works, site migrated to SPA |
| openjudge | Requires authentication |
| poj | Site unreachable |
| qoj | Requires authentication |
| scu | Site offline |
